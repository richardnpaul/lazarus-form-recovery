...
# Runs on Stop hook to extract reusable patterns from Antigravity sessions
#
...
# Get transcript path from environment (set by Antigravity)
...
# Signal to agents that session should be evaluated for extractable patterns
